...
<Tabs>
  ...
  <Tab title="BSD">
    ...
    Full server and client routing support is available on **OpenBSD, FreeBSD, DragonFly BSD, and NetBSD**. On other BSDs, only client and point-to-point operation is supported.
