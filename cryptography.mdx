---
title: "DSVPN Cryptography: Charm AEAD Stream Cipher"
sidebarTitle: "Cryptography"
description: "DSVPN encrypts traffic using the Charm library, a formally verified AEAD stream cipher. Learn the key exchange protocol, packet format, and session key derivation."
---
...
Charm is an AEAD (Authenticated Encryption with Associated Data) stream cipher built on the [Xoodoo](https://keccak.team/xoodoo.html) permutation — a 12-round ARX-based construction operating on a 48-byte state represented as 12 `uint32_t` words. Implementations have been formally verified and the library is embedded directly in the DSVPN source tree.
