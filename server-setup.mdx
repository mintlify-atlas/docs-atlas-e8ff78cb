...
<Tabs>
  <Tab title="Linux">
    ...
    **Enable IP forwarding and configure the TUN interface**
    ```bash
  ...
  <Tab title="macOS / BSD">
    ...
    **Configure TUN interface (IPv4)**
    ```bash
    ifconfig <tun> 192.168.192.254 192.168.192.1 up
    ```

    **Configure TUN interface (IPv6)**
    ```bash
    ifconfig <tun> inet6 64:ff9b::192.168.192.254 64:ff9b::192.168.192.1 prefixlen 128 up
    ```
